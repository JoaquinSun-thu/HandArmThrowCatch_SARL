...
class RolloutStorage:
    ...
    def sample(self, batch_size):
        ...
        ind = torch.randint(0, self.num_envs * self.num_transitions_per_env, size=(batch_size,))
        # print(self.states.shape)
        observations_batch = self.observations.view(-1, *self.observations.size()[2:])[ind]
        actions_batch = self.actions.view(-1, self.actions.size(-1))[ind]

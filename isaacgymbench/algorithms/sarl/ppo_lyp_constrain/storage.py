...
class RolloutStorage:
    ...
    def compute_returns(self, last_values, last_lyp_values, gamma, lam, current_iter, num_max_iter):
        ...
        # print("current_iter:=" + str(current_iter))
        # print("max_iter:=" + str(num_max_iter))
        # print(str(pow(torch.abs(last_lyp_values), self.constrain_alpha)))
        # print("lyp_values_constrain:=" + str(self.lyp_values_constrain))
        ...
        for step in reversed(range(self.num_transitions_per_env)):
            ...
            totle_advantage = self.alpha * intri_advantage + self.belta * lyp_advantage + (1 - self.alpha - self.belta) * advantage

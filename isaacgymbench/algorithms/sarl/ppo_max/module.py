...
class ActorCritic(nn.Module):
    ...
    def __init__(self, obs_shape, states_shape, actions_shape, initial_std, model_cfg, asymmetric=False):
        ...
        if model_cfg is None:
            ...
            activation = get_activation("selu") # selu
        else:
        ...
        # for l in range(len(actor_layers)):
        #     if l == len(actor_layers) - 1:
        #         orthogonal_init(actor_layers[l], gain=0.01)
        #     else:
        #         orthogonal_init(actor_layers[l])
        ...
        #     orthogonal_init(critic_layers[l])

...
class ShadowHandCatchOverarm(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        small_objects = ["block", "egg", "pen", "mug", "poker", "banana", "clamp", "stapler", "suger", "bowl", "pen_container", "apple", "peach", "pear", "strawberry", "bottle"]
        ...
        if self.object_type == "pen":
            ...
            object_start_pose.p.z = shadow_hand_start_pose.p.z + 0.48
        # # 调试    
